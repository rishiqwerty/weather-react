...
function App() {
  ...
  const changeTheme = () => {
    let body_atr = document.querySelector("body")
    console.log(body_atr.getAttribute("data-theme") )
    theme == "light" ? 
        body_atr.setAttribute("data-theme", "dark") : 
        body_atr.setAttribute("data-theme", "light")
    ...
    <div className="m-2" >
      <header className="d-flex flex-column align-items-center mt-5">
        ...
        <div className="form-check form-switch">
          <input className="form-check-input" onChange={changeTheme} type="checkbox" role="switch" id="flexSwitchCheckChecked"  />
